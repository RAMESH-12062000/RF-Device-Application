		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comapprfdeviceapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapprfdeviceapplication-display": {
								"semanticObject": "comapprfdeviceapplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.rfdeviceapplication",
									"url": sap.ui.require.toUrl("com/app/rfdeviceapplication")
								}
							}
						}
					}
